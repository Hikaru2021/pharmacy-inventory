...
<template>
   <div>
   <section class="py-10 sm:py-16 lg:py-24 bg-cover" style="background-image: url('https://forencisdata.com/assets/img/ForencisData-pics/epidemiologists-banner.webp');" >
